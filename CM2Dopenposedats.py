...
def run(path, path_saida):
    ...
    np.savetxt(path_saida, saida, fmt=fmt)
    print( 'Centro de massa  calculado com sucesso')

if __name__ == '__main__':

    path = 'C:\\Users\\rafae\\OneDrive\\Documentos\\Mestrado\\reconstrucao_3d_pose\\Salto_vertical\\Reconstrucao_3d\\for3d\\c1\\dvideow_people_0f.dat'
    path_saida = 'C:\\Users\\rafae\\OneDrive\\Documentos\\Mestrado\\reconstrucao_3d_pose\\Salto_vertical\\Reconstrucao_3d\\for3d\\c1\\dvideow_people_0cm.dat'
    main(path)
    run(path, path_saida)
    
    
    path = 'C:\\Users\\rafae\\OneDrive\\Documentos\\Mestrado\\reconstrucao_3d_pose\\Salto_vertical\\Reconstrucao_3d\\for3d\\c2\\dvideow_people_0f.dat'
    path_saida = 'C:\\Users\\rafae\\OneDrive\\Documentos\\Mestrado\\reconstrucao_3d_pose\\Salto_vertical\\Reconstrucao_3d\\for3d\\c2\\dvideow_people_0cm.dat'
    main(path)
    run(path, path_saida)
